...
export const SINIF_KISITLAMA: Record<string, Partial<Record<string, number[]>>> = {
  din_kulturu: { ilkokul: [4] },       // DKAB ilkokulda yalnızca 4. sınıf
  ingilizce:   { ilkokul: [2, 3, 4] }, // İngilizce ilkokulda 1. sınıf yok
...
const BRANS_DERSLER: Record<string, BransDersler> = {
  turkce: {
    ...
    secmeli: [
      { ad: 'Yazarlık ve Yazma Becerileri', siniflar: [5,6,7,8], okul_tipleri: ['ortaokul'] },
      { ad: 'Okuma Becerileri',             siniflar: [5,6,7,8], okul_tipleri: ['ortaokul'] },
      { ad: 'Masal ve Destanlarımız',       siniflar: [5,6,7,8], okul_tipleri: ['ortaokul'] },
      { ad: 'Medya Okuryazarlığı',          siniflar: [7,8],     okul_tipleri: ['ortaokul'] },
    ],
  },
  turk_dili_edebiyati: {
    zorunlu: [{ ad: 'Türk Dili ve Edebiyatı', siniflar: [9,10,11,12], okul_tipleri: ['lise','ihl'] }],
    secmeli: [
      { ad: 'Metin Tahlilleri',              siniflar: [9,10,11,12], okul_tipleri: ['lise','ihl'] },
      { ad: 'Osmanlı Türkçesi',              siniflar: [10,11,12],   okul_tipleri: ['lise','ihl'] },
      { ad: 'Ortak Türk Edebiyatı',          siniflar: [10,11,12],   okul_tipleri: ['lise','ihl'] },
      { ad: 'Seçmeli Edebiyat Uygulamaları', siniflar: [9,10,11,12], okul_tipleri: ['lise','ihl'] },
    ],
  },
  matematik: {
    zorunlu: [{ ad: 'Matematik', siniflar: [5,6,7,8,9,10,11,12], okul_tipleri: ['ortaokul','iho','lise','ihl'] }],
    secmeli: [
      { ad: 'Düşünme Eğitimi',                siniflar: [5,6,7,8,9,10,11,12], okul_tipleri: ['ortaokul','lise'] },
      { ad: 'Matematik ve Bilim Uygulamaları', siniflar: [5,6,7,8],            okul_tipleri: ['ortaokul'] },
  ...
  fen_bilimleri: {
    ...
    secmeli: [
      { ad: 'Afet Bilinci',                       siniflar: [5,6,7,8], okul_tipleri: ['ortaokul'] },
      { ad: 'Proje Tasarımı ve Uygulamaları',      siniflar: [5,6,7,8], okul_tipleri: ['ortaokul'] },
      { ad: 'Matematik ve Bilim Uygulamaları',     siniflar: [5,6,7,8], okul_tipleri: ['ortaokul'] },
      { ad: 'Çevre Eğitimi ve İklim Değişikliği', siniflar: [5,6,7,8], okul_tipleri: ['ortaokul'] },
    ],
  },
  sosyal_bilgiler: {
    ...
    zorunlu: [
      ...
      { ad: 'T.C. İnkılap Tarihi', siniflar: [8],     okul_tipleri: ['ortaokul','iho'] },
    ],
    secmeli: [
      { ad: 'Şehrimiz',                                   siniflar: [5,6,7,8], okul_tipleri: ['ortaokul'] },
      { ad: 'Kültür ve Medeniyetimize Yön Verenler',      siniflar: [5,6,7,8], okul_tipleri: ['ortaokul'] },
      { ad: 'Türk Sosyal Hayatında Aile',                 siniflar: [5,6,7,8], okul_tipleri: ['ortaokul'] },
      { ad: 'Hukuk ve Adalet',                            siniflar: [5,6,7,8], okul_tipleri: ['ortaokul'] },
      { ad: 'Okul Temelli Sosyal Sorumluluk Çalışmaları', siniflar: [5,6,7,8], okul_tipleri: ['ortaokul'] },
    ],
  },
  tarih: {
    zorunlu: [
    ...
    secmeli: [
      { ad: 'Sanat Tarihi',                  siniflar: [9,10,11,12], okul_tipleri: ['lise','ihl'] },
      { ad: 'Çağdaş Türk ve Dünya Tarihi',   siniflar: [12],         okul_tipleri: ['lise','ihl'] },
      { ad: 'Uluslararası İlişkiler',        siniflar: [11,12],      okul_tipleri: ['lise','ihl'] },
      { ad: 'İslam Bilim Tarihi',            siniflar: [9,10,11,12], okul_tipleri: ['lise','ihl'] },
      { ad: 'Ortak Türk Tarihi',             siniflar: [9,10,11,12], okul_tipleri: ['lise','ihl'] },
      { ad: 'Türk Kültür ve Medeniyet Tarihi', siniflar: [9,10,11,12], okul_tipleri: ['lise','ihl'] },
      { ad: 'Türk Düşünce Tarihi',           siniflar: [10,11,12],   okul_tipleri: ['lise','ihl'] },
  ...
  cografya: {
    ...
    secmeli: [
      ...
      { ad: 'Türk Dünyası Coğrafyası',                   siniflar: [10,11,12],   okul_tipleri: ['lise','ihl'] },
      { ad: 'Sürdürülebilir Tarım ve Gıda Güvenliği',    siniflar: [10,11],      okul_tipleri: ['lise','ihl'] },
      { ad: 'Sosyal Bilim Çalışmaları',                  siniflar: [9,10,11,12], okul_tipleri: ['lise','ihl'] },
    ],
  },
  felsefe: {
    ...
    secmeli: [
      ...
      { ad: 'Ekonomi',                    siniflar: [11,12],      okul_tipleri: ['lise','ihl'] },
      { ad: 'İşletme',                    siniflar: [11,12],      okul_tipleri: ['lise','ihl'] },
      { ad: 'Girişimcilik',               siniflar: [11,12],      okul_tipleri: ['lise','ihl'] },
      { ad: 'Temel Hukuk Bilgisi',        siniflar: [10,11,12],   okul_tipleri: ['lise','ihl'] },
      { ad: 'Sosyal Bilim Çalışmaları',   siniflar: [9,10,11,12], okul_tipleri: ['lise','ihl'] },
      { ad: 'Yönetim Bilimi',             siniflar: [11,12],      okul_tipleri: ['lise','ihl'] },
      { ad: 'Türk Sosyal Hayatında Aile', siniflar: [9,10,11,12], okul_tipleri: ['lise','ihl'] },
      { ad: 'Türk Düşünce Tarihi',        siniflar: [10,11,12],   okul_tipleri: ['lise','ihl'] },
    ],
  },
  fizik: {
    ...
    secmeli: [
      ...
      { ad: 'Proje Tasarımı ve Uygulamaları', siniflar: [9,10,11,12], okul_tipleri: ['lise','ihl'] },
      { ad: 'Fen Bilimleri Uygulamaları',     siniflar: [11,12],      okul_tipleri: ['lise','ihl'] },
    ],
  },
  kimya: {
  ...
  biyoloji: {
    ...
    secmeli: [
      { ad: 'Genetik Bilimine Giriş',                  siniflar: [11,12], okul_tipleri: ['lise','ihl'] },
      { ad: 'Tıp Bilimine Giriş',                      siniflar: [11,12], okul_tipleri: ['lise','ihl'] },
      { ad: 'Fen Bilimleri Uygulamaları',              siniflar: [11,12], okul_tipleri: ['lise','ihl'] },
      { ad: 'Sürdürülebilir Tarım ve Gıda Güvenliği', siniflar: [10,11], okul_tipleri: ['lise','ihl'] },
      { ad: 'İklim, Çevre ve Yenilikçi Çözümler',     siniflar: [10,11], okul_tipleri: ['lise','ihl'] },
    ],
  ...
  din_kulturu: {
    ...
    secmeli: [
      ...
      { ad: 'Ahlak ve Vatandaşlık Eğitimi',      siniflar: [5,6,7,8],    okul_tipleri: ['ortaokul'] },
      { ad: 'Görgü Kuralları ve Nezaket',         siniflar: [5,6,7,8],    okul_tipleri: ['ortaokul'] },
      ...
      { ad: 'Kur\'an-ı Kerim\'in Anlam Dünyası',  siniflar: [9,10,11,12], okul_tipleri: ['lise'] },
      { ad: 'İslam Kültür ve Medeniyeti',         siniflar: [9,10,11,12], okul_tipleri: ['lise'] },
      { ad: 'İslam Bilim Tarihi',                 siniflar: [9,10,11,12], okul_tipleri: ['lise'] },
      { ad: 'Adabımuaşeret',                      siniflar: [9,10,11,12], okul_tipleri: ['lise'] },
      { ad: 'Klasik Ahlak Metinleri',             siniflar: [10,11,12],   okul_tipleri: ['lise'] },
    ],
  },
  ihl_meslek_dersleri: {
    zorunlu: [
      ...
      { ad: 'Hüsn-i Hat',                 siniflar: [10,11,12],   okul_tipleri: ['ihl'] },
    ...
    secmeli: [
      { ad: 'Kur\'an-ı Kerim\'in Anlam Dünyası', siniflar: [9,10,11,12], okul_tipleri: ['ihl'] },
      { ad: 'İslam Kültür ve Medeniyeti',         siniflar: [9,10,11,12], okul_tipleri: ['ihl'] },
      { ad: 'İslam Bilim Tarihi',                 siniflar: [9,10,11,12], okul_tipleri: ['ihl'] },
      { ad: 'Adabımuaşeret',                      siniflar: [9,10,11,12], okul_tipleri: ['ihl'] },
      { ad: 'Klasik Ahlak Metinleri',             siniflar: [10,11,12],   okul_tipleri: ['ihl'] },
      { ad: 'Din Eğitimi',                        siniflar: [9],          okul_tipleri: ['ihl'] },
      { ad: 'İslam Felsefesi',                    siniflar: [11,12],      okul_tipleri: ['ihl'] },
      { ad: 'İslam\'da Çocuk Eğitimi',            siniflar: [11,12],      okul_tipleri: ['ihl'] },
      { ad: 'Kur\'an\'ın Ana Konuları',            siniflar: [10,11],      okul_tipleri: ['ihl'] },
      { ad: 'Tasavvuf Kültürü',                   siniflar: [11,12],      okul_tipleri: ['ihl'] },
    ],
  },
  gorsel_sanatlar: {
    zorunlu: [
  ...
  muzik: {
    ...
    secmeli: [
      { ad: 'Seçmeli Müzik',        siniflar: [5,6,7,8],    okul_tipleri: ['ortaokul'] },
      { ad: 'Halk Oyunları',         siniflar: [5,6,7,8],    okul_tipleri: ['ortaokul'] },
      { ad: 'Sanat Eğitimi (Müzik)', siniflar: [9,10,11,12], okul_tipleri: ['lise'] },
    ],
  },
  beden_egitimi: {
    zorunlu: [
    ...
    secmeli: [
      { ad: 'Halk Oyunları',  siniflar: [5,6,7,8],    okul_tipleri: ['ortaokul'] },
      { ad: 'Spor Eğitimi',   siniflar: [9,10,11,12], okul_tipleri: ['lise','ihl'] },
  ...
  bilisim_teknolojileri: {
    ...
    secmeli: [
      { ad: 'Bilişim Teknolojileri ve Yazılım', siniflar: [9,10,11,12], okul_tipleri: ['lise'] },
      { ad: 'Robotik Kodlama',                  siniflar: [5,6,7,8,9,10,11,12], okul_tipleri: ['ortaokul','lise'] },
      { ad: 'Yapay Zeka Uygulamaları',          siniflar: [7,8],        okul_tipleri: ['ortaokul'] },
      { ad: 'Dijital Sanatlar',                 siniflar: [5,6,7,8],    okul_tipleri: ['ortaokul'] },
    ],
  },
  sinif_ogretmeni: {
