...
<style>
  ...
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .imza-alani { margin-top: 24px; display: flex; justify-content: space-between; page-break-inside: avoid; break-inside: avoid; page-break-before: avoid; break-before: avoid; }
